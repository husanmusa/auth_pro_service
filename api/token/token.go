...
import (
	...
	"github.com/husanmusa/auth_pro_service/api/models"
...
type TokenInterface interface {
	...
	ExtractTokenMetadata(*fasthttp.Request) (*models.AccessDetails, error)
}
...
func (t *TokenManager) ExtractTokenMetadata(r *fasthttp.Request) (*models.AccessDetails, error) {
...
func ExtractTokenMetadata(r *fasthttp.Request) (*models.AccessDetails, error) {
	token, err := VerifyToken(r)
	if err != nil {
		return nil, err
	}
